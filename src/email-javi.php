...
$sql.=" INNER JOIN LOCATION LO ON LO.LOCATION_ID=RES.LOCATION_ID INNER JOIN USER US ON US.USER_ID=LO.RETAILER_ID INNER JOIN USER US3 ON RES.CLIENT_ID=US3.USER_ID INNER JOIN PERSON PE3 ON PE3.PERSON_ID=US3.PERSON_ID INNER JOIN LOCATION_SERVICE LS ON LS.LS_ID=RES.LS_ID INNER JOIN SERVICE SER ON SER.SERVICE_ID=LS.SERVICE_ID INNER JOIN SCHEDULE_LOCATION SCHLO ON SCHLO.ID=RES.SCHEDULE_LOCATION INNER JOIN SCHEDULE SCHE ON SCHE.SCHEDULE_ID=SCHLO.SCHEDULE_ID WHERE RESERVATION_ID=".$RESERVATION_ID;
  try {
    ...
    <h3>".$NAME.", Thank You for choosing EZ CarWash.</h3> <p class='lead'>This is a confirmation that you have booked the following items:</p>
    <!-- A Real Hero (and a real human being) --> <p><img 'src='http://ezcwash.com/email/ezcwash_image.png' /></p><!-- /hero -->
    <!-- Callout Panel --> <p class='callout'> DATE: ".$DATE." <br> TIME: ".$TIME." <br> SERVICE: ".$SERVICE." <br>ADDITIONALS:".$ADDS." <br> PRICE: $".$PRICE."  <br> LOCATION: ".$LOCATION."<br>
	Your car will be ready 45 mins after your appointment.<BR>
	This service doesn't accept cancellations.  <br>
	If you want make a Reschedule, You can do it until 12 hrs before your appointment<br> <a href='http://ezcwash.com/booking/production/'>Reschedule Here &raquo;</a> </p><!-- /Callout Panel -->
     <p class='callout'>REMEMBER: <br> We are not responsible for personal items left in vehicles. Please Double-check to see that you have your wallet, purse, camera, or any other personal item.
    ...
    <h5 class='>Connect with Us:</h5> <p class='><a href='https://www.facebook.com/ezcwash/' class='soc-btn fb'>Facebook</a> <a href='https://twitter.com/@ezcwash' class='soc-btn tw'>Twitter</a> <a href='https://www.instagram.com/ezcwash/' class='soc-btn ins'>Instagram</a></p>
    </td> </tr> </table><!-- /column 1 -->
    <!--- column 2 --> <table align='left' class='column'> <tr> <td>
    <h5 class='>EZ Carwash</h5> <p>Phone: <strong>+1 (936)703-8748</strong><br/> Email: <strong><a href='emailto:ezcs@ezcwash.com'>ezcs@ezcwash.com</a></strong></p> Website: <a href='http://ezcwash.com/'>www.ezcwash.com </a></p>
...
$sql.=" WHERE RES.RESERVATION_ID=".$RESERVATION_ID;
  ...
  try {
    ...
    <div class='content'>
    <table><tr><td>
    <h3>".$CLIENT_NAME.", Thanks for choosing EZ CarWash </h3>
    ...
    </p><h3>Thank you for choosing our company.</p><br></h3>
    ...
    <br/><br/><table class='social' width='100%'>
    <tr><td><table align='left' class='column'>
    <tr><td><h5 >Connect with Us:</h5>
    <p ><a href='https://www.facebook.com/ezcwash/' class='soc-btn fb'>Facebook</a> <a href='https://twitter.com/@ezcwash' class='soc-btn tw'>Twitter</a> <a href='https://www.instagram.com/ezcwash/' class='soc-btn ins'>Instagram</a></p>
    </td></tr></table><table align='left' class='column'>
    <tr><td><h5 >EZ Carwash</h5><p>Phone: <strong>+1 (936)703-8748</strong><br/>
    Email: <strong><a href='emailto:ezcs@ezcwash.com'>ezcs@ezcwash.com</a></strong></p>
    Website: <a href='http://ezcwash.com/'>www.ezcwash.com </a></p>
    </td></tr></table><span class='clear'></span>
    </td></tr></table></td></tr></table></div></td>
    <td></td></tr></table><table class='footer-wrap'>
    <tr><td></td><td class='container'><div class='content'>
    <table><tr><td align='center'><p>
    <a href='http://ezcwash.com/faqs.html'>Terms</a> |
    <a href='http://ezcwash.com/faqs.html'>Privacy</a> |
    </p></td></tr></table></div></td><td></td>
    </tr></table></body>
    </html>";
