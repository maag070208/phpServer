...
{
  $sql = "SELECT RES.RESERVATION_ID,US.USER_NAME AS RETAILER,LO.ZIP,LO.LOCATION_NAME AS LOCATION,CONCAT(PE3.NAME,' ',PE3.LAST_NAME) AS CLIENT_NAME,PE3.EMAIL AS CLIENT_EMAIL,SER.SERVICE_NAME,DATE_FORMAT(RES.DATE,'%m-%d-%Y') AS DATE,SCHE.HOUR ,CONCAT(CARME.MAKE_NAME,' ',CARM.MODEL_NAME,' ',VEH.YEAR) AS VEHICLE,VEH.PLATE,VEH.COLOR, RES.TOTAL,RES.TAX,RES.TRANSACCION,US3.USER_NAME  FROM RESERVATION RES INNER JOIN VEHICLE_DETAIL VEH ON VEH.VHE_DETAIL=RES.VEHICLE_DETAIL INNER JOIN CAR_MAKE CARME";
  ...
  try {
    ...
    $msg = "<html>";
    $msg .= "<head>
    <link rel='stylesheet' type='text/css' href='http://myezcarwash.com/email/stylesheets/email.css' />
    <style>
    ...
    <div class='content'> <table bgcolor='#fff'> <tr> <td>
    <a href='http://ridewash.com/'><img src='http://myezcarwash.com/email/ridewash.png' width='35%' /></a>
    </td>
    </tr> </table> </div>
    ...
    <h3>" . $NAME . " thank you for choosing RideWash.</h3> <p class='lead'>This is a confirmation that you have booked the following items:</p>
    <!-- A Real Hero (and a real human being) --> <p><img 'src='http://myezcarwash.com/email/ezcwash_image.png' /></p><!-- /hero -->
	...
	If you want make a Reschedule, You can do it until 12 hrs before your appointment<br> <a href='http://www.myezcarwash.com/booking/home.html#!/books?token=" . $TOKEN . "'>Reschedule Here &raquo;</a> </p><!-- /Callout Panel -->
     <p class='callout'>REMEMBER: <br> We are not responsible for personal items left in vehicles. Please Double-check to see that you have your wallet, purse, camera, or any other personal item.<BR>
	 We don't accept CASH. Our policy of insurance is not responsible for any transaction on cash; we ONLY accept credit cards payments.<BR>

	</p> <a href='tel:+19367038748'class='btn' style='background-color:#ddd;'>Call Us: +1 (936)703-8748</a>
    <br/> <br/>
	<!-- social & contact -->
									...
									<table align='left' class='column'>
										<tr>
											<td>
												...
												<h5 class=''>RideWash</h5>
												<p>Phone: <strong>+1 (936)703-8748</strong><br/>
												<p>Email: <strong><a href='emailto:services@ridewash.com'>services@ridewash.com</a></strong></p>
												<p>Website: <a href='http://ridewash.com/'>http://ridewash.com/ </a></p>
    ...
    <!-- content --> <div class='content'> <table> <tr> <td align='center'> <p> <a href='http://myezcarwash.com/faqs.html'>Terms</a> | <a href='http://myezcarwash.com/faqs.html'>Privacy</a> |
    ...
    $subject = 'Your RideWash appointment ';

    $headers = "From: services@ridewash.com\r\n";
    $headers .= "Reply-To: services@ridewash.com\r\n";
    $headers .= "CC: services@ridewash.com\r\n";
...
function sendContactMail($name, $email, $phone, $msg)
{
  $to = "services@ridewash.com";
...
function sendContactMail2($name, $email, $phone, $company, $address, $time)
{
  $to = "services@ridewash.com";
  $subject = 'Contact Form';
  $headers = "From: services@ridewash.com\r\n";
  ...
  $message .= '<br><b>Email: </b>' . $email;
  $message .= '<br><b>Phone: </b>' . $phone;
  $message .= '<br><b>Company : </b>' . $company;
  $message .= '<br><b>Address : </b>' . $address;
  $message .= '<br><b>Best time to contact : </b>' . $time;
  $message .= '</body></html>';
  mail($to, $subject, $message, $headers);
  $db = null;
  return $to;
...
function sendClientReschedule($RESERVATION_ID)
{
  ...
  try {
    ...
    <!-- BODY --> <table class='body-wrap'> <tr> <td></td> <td class='container' bgcolor='#FFFFFF'>
    <div class='content'> <table> <tr> <td>
    <h3>" . $NAME . " thank you for choosing RideWash.</h3> <p class='lead'>This is a confirmation that you have rescheduled the following items:</p>
    <!-- A Real Hero (and a real human being) --> <p><img 'src='http://myezcarwash.com/email/ezcwash_image.png' /></p><!-- /hero -->
...
function sendAdminData($RESERVATION_ID)
{
  ...
  $sql .= " AS VEHICLE,VEH.PLATE,VEH.COLOR, RES.TOTAL,RES.TAX,RES.TRANSACCION,RES.ADDRESS  FROM RESERVATION RES INNER JOIN VEHICLE_DETAIL VEH ON VEH.VHE_DETAIL=RES.VEHICLE_DETAIL INNER JOIN CAR_MAKE CARME ON CARME.MAKE_ID=VEH.MAKE INNER JOIN CAR_MODEL CARM ON CARM.MODEL_ID=VEH.MODEL INNER JOIN LOCATION LO ON ";
  ...
  try {
    ...
    $sql = "SELECT ADDITIONAL_NAME,AD.PRICE FROM RESERVATION_ADDITIONAL_SERVICE RAS LEFT JOIN ADDITIONAL AD ON AD.ADDITIONAL_ID=RAS.ADDITIONAL_ID WHERE RESERVATION_ID=" . $RESERVATION_ID;
    $gsent = $db->prepare($sql);
    $gsent->execute();
    $resultado2 = $gsent->fetchAll();
    $additionals = "";
    ...
    <table><tr><td><h3>You have a new booking. " . $LOCATION . "</h3><p class='lead'><b>Service:</b>" . $SERVICE . "<br>
    <b>ADDITIONALS:</b> " . $additionals . "<br>
    <br>
    <b>TOTAL:</b> " . $TOTAL . "<br>
    </p>
    <!--CalloutPanel-->
    ...
    <a href='http://myezcarwash.com/faqs.html'>Terms</a>|
    <a href='http://myezcarwash.com/faqs.html'>Privacy</a>|
    </p></td></tr></table></div>
    ...
    $headers = "From: services@ridewash.com\r\n";
    $headers .= "Reply-To: services@ridewash.com\r\n";
    $headers .= "CC: services@ridewash.com,wash@ridewash.com\r\n";
    $headers .= "MIME-Version: 1.0\r\n";
    $headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
    // use wordwrap() if lines are longer than 70 characters
    // send email
...
function sendAdminData2($RESERVATION_ID)
{
  $sql = "SELECT RES.RESERVATION_ID,US.USER_NAME AS RETAILER,PE4.EMAIL AS RETAILER_EMAIL,LO.ZIP,LO.LOCATION_NAME AS LOCATION,CONCAT(PE3.NAME,' ',PE3.LAST_NAME) AS CLIENT_NAME,PE3.EMAIL AS CLIENT_EMAIL,PE3.PHONE,SER.SERVICE_NAME,DATE_FORMAT(RES.DATE,'%m-%d-%Y') AS DATE,SCHE.HOUR ,CONCAT(CARME.MAKE_NAME,' ',CARM.MODEL_NAME,' ',VEH.YEAR) ";
  $sql .= " AS VEHICLE,VEH.PLATE,VEH.COLOR, RES.TOTAL,RES.TAX,RES.TRANSACCION,RES.ADDRESS  FROM RESERVATION RES INNER JOIN VEHICLE_DETAIL VEH ON VEH.VHE_DETAIL=RES.VEHICLE_DETAIL INNER JOIN CAR_MAKE CARME ON CARME.MAKE_ID=VEH.MAKE INNER JOIN CAR_MODEL CARM ON CARM.MODEL_ID=VEH.MODEL INNER JOIN LOCATION LO ON ";
  $sql .= " LO.LOCATION_ID=RES.LOCATION_ID INNER JOIN USER US ON US.USER_ID=LO.RETAILER_ID INNER JOIN PERSON PE4 ON PE4.PERSON_ID=US.PERSON_ID INNER JOIN USER US3 ON RES.CLIENT_ID=US3.USER_ID INNER JOIN PERSON PE3 ON PE3.PERSON_ID=US3.PERSON_ID INNER JOIN LOCATION_SERVICE LS ON LS.LS_ID=RES.LS_ID ";
  ...
  try {
    ...
    $headers = "From: services@ridewash.com\r\n";
    $headers .= "Reply-To: services@ridewash.com\r\n";
    $headers .= "CC: edgar.valdezr@gmail.com,javi.perez@myezcarwash.com,wash@ridewash.com\r\n";
    $headers .= "MIME-Version: 1.0\r\n";
    $headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
    // use wordwrap() if lines are longer than 70 characters
    // send email
...
function sendCompleted($RESERVATION_ID, $TRANS)
{
  ...
  try {
    ...
    <div class='content'>
    <table><tr><td>
    <h3>" . $CLIENT_NAME . " thank you for choosing RideWash </h3>
    <p class='lead'>DATE: " . $DATE . " " . $TIME . " /RideWash</p>
    <div>
      <h2 style='float:left;color:#78ca3c;'>TIPS are much appreciated<br>Thank you!</h2>
									...
									<table align='left' class='column'>
										<tr>
											<td>
												...
												<p>Phone: <strong>+1 (936)703-8748</strong><br/>
												<p>Email: <strong><a href='emailto:services@ridewash.com'>services@ridewash.com</a></strong></p>
												<p>Website: <a href='http://ridewash.com/'>www.myezcarwash.com </a></p>
    ...
    $subject = 'RideWash service is done';
...
function sendForgetPassword($email, $newPass, $name)
{

  try {
    $msg = "  <!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Transitional//EN' 'http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd'> <html xmlns='http://www.w3.org/1999/xhtml'> <head> <!-- If you delete this tag, the sky will fall on your head --> <meta name='viewport' content='width=device-width' />
  <meta http-equiv='Content-Type' content='text/html; charset=UTF-8' /> <title>EZ CWASH BOOKING</title>
  ...
  <!-- BODY --> <table class='body-wrap'> <tr> <td></td> <td class='container' bgcolor='#FFFFFF'>
  <div class='content'> <table> <tr> <td>
  <h3>Hi," . $name . ". We have reset your password.</h3> <p class='lead'></p>
  <!-- A Real Hero (and a real human being) --> <p><img 'src='http://myezcarwash.com/email/ezcwash_image.png' /></p><!-- /hero -->
  <!-- Callout Panel --> <p class='callout'><b> New Password</b>:" . $newPass . " <br><BR> This is a temporary password. You can change it once you have logged into the application by clicking on the menu in the upper left corner button and then on 'Change password'.<br> </p><!-- /Callout Panel -->
  </p><br/> <br/>
  <!-- social & contact --> <table class='social' width='100%'> <tr> <td>
  <!--- column 1 --> <table align='left' class='column'> <tr> <td>
  <h5 class='>Connect with Us:</h5> <p class='><a href='https://www.facebook.com/ezcwash/' class='soc-btn fb'>Facebook</a> <a href='#' class='soc-btn tw'>Twitter</a> <a href='#' class='soc-btn gp'>Google+</a></p>
  </td> </tr> </table><!-- /column 1 -->
  <!--- column 2 --> <table align='left' class='column'> <tr> <td>
  <h5 class='>RideWash</h5> <p>Phone: <strong>+1 (936)703-8748</strong><br/> Email: <strong><a href='emailto:services@ridewash.com'>services@ridewash.com</a></strong></p> Website: <a href='http://ridewash.com/'>http://ridewash.com/ </a></p>
  </td> </tr> </table><!-- /column 2 -->
  <span class='clear'></span>
  </td> </tr> </table><!-- /social & contact -->
  </td> </tr> </table> </div>
  </td> <td></td> </tr> </table><!-- /BODY -->
  <!-- FOOTER --> <table class='footer-wrap'> <tr> <td></td> <td class='container'>
  <!-- content --> <div class='content'> <table> <tr> <td align='center'> <p> <a href='http://myezcarwash.com/faqs.html'>Terms</a> | <a href='http://myezcarwash.com/faqs.html'>Privacy</a> |
...
function sendUserFBInfo($email, $user, $pass)
{
  ...
  try {
    ...
    <div class='content'>
    <table><tr><td>
    <h3>Welcome and thank you for choosing RideWash - RideWash </h3>
